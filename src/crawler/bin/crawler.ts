 ...
 */
const CONSTRUCT_NAME_PREFIX = 'Abacus';

/**
 * The name of the state machine.
 */
const CRAWLER_STATE_MACHINE_NAME = 'abacus-crawler-state-machine';
 ...
 */
const S3_QUEUED_URLS_KEY = 'temp-crawler-urls/queuedUrls.json';

/**
 * The prefix that is prepended to the name of the URL table.
 */
const URL_TABLE_NAME_PREFIX = 'crawler-urls';
